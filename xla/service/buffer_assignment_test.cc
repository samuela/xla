...
TEST(ComputePeakMemoryTest, MultipleBuffers) {
  ...
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo)->padded, 60);
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo)->unpadded, 60);
}
...
TEST(ComputePeakMemoryTest, SharedBuffers) {
  ...
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo)->padded, 10);
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo)->unpadded, 10);
  ...
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo)->padded, 20);
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo)->unpadded, 20);
}
...
TEST(ComputePeakMemoryTest, SharedChain) {
  ...
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo)->padded, 310);
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo)->unpadded, 310);
  ...
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo)->padded, 4000);
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo)->unpadded, 4000);
}
...
TEST(ComputePeakMemoryTest, SharingAllocatesBuffers) {
  ...
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo)->padded, 200);
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo)->unpadded, 200);
}

TEST(ComputePeakMemoryTest, EmptyProto) {
  HloModuleProto hlo;
  BufferAssignmentProto proto;
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo)->padded, 0);
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo)->unpadded, 0);
}
...
TEST(ComputePeakMemoryTest, MultipleAssignments) {
  ...
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo)->padded, 333);
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo)->unpadded, 333);
}
...
TEST(ComputePeakMemoryTest, ShareParameter) {
  ...
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo)->padded, 1024);
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo)->unpadded, 1024);
}
...
TEST(ComputePeakMemoryTest, ParamBufferAndAllocationBuffer) {
  ...
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo)->padded, 123 + 321);
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo)->unpadded, 123 + 321);
}
...
TEST(ComputePeakMemoryTest, LargeResult) {
  ...
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo)->padded, 1LL << 33);
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo)->unpadded, 1LL << 33);
}
