...
#ifndef XLA_BACKENDS_GPU_RUNTIME_DEVICE_TO_HOST_COPY_THUNK_H_
#define XLA_BACKENDS_GPU_RUNTIME_DEVICE_TO_HOST_COPY_THUNK_H_
...
#endif  // XLA_BACKENDS_GPU_RUNTIME_DEVICE_TO_HOST_COPY_THUNK_H_
